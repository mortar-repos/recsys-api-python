...
class API(object):
    ...
    HEADERS = {'Accept': 'application/json',
               ...
               # TODO add version
               'User-Agent': 'recsys-api-python'}

    def __init__(self, api_id, api_key, scheme='https', host='recs.mortardata.com'):
        self.auth = HTTPBasicAuth(api_id, api_key)
        self.scheme = scheme
        self.host = host

    def url(self, path):
        return '%s://%s/v1/recommend/%s' % (self.scheme, self.host, path)
